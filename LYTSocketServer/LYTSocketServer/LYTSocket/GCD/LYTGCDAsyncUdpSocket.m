...
@class LYTGCDAsyncUdpSendPacket;

NSString *const LYTGCDAsyncUdpSocketException = @"LYTGCDAsyncUdpSocketException";
NSString *const LYTGCDAsyncUdpSocketErrorDomain = @"LYTGCDAsyncUdpSocketErrorDomain";

NSString *const LYTGCDAsyncUdpSocketQueueName = @"LYTGCDAsyncUdpSocket";
NSString *const LYTGCDAsyncUdpSocketThreadName = @"LYTGCDAsyncUdpSocket-CFStream";

enum LYTGCDAsyncUdpSocketFlags
{
...
enum LYTGCDAsyncUdpSocketConfig
{
...
@interface LYTGCDAsyncUdpSocket ()
{
	...
	LYTGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	LYTGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	LYTGCDAsyncUdpSendPacket *currentSend;
...
/**
 * The LYTGCDAsyncUdpSendPacket encompasses the instructions for a single send/write.
**/
@interface LYTGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation LYTGCDAsyncUdpSendPacket
...
@interface LYTGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation LYTGCDAsyncUdpSpecialPacket
...
@implementation LYTGCDAsyncUdpSocket
...
- (id)initWithDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (id)initWithDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([LYTGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (void)setDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id <LYTGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <LYTGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LYTGCDAsyncUdpSocketErrorDomain
	                           code:LYTGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LYTGCDAsyncUdpSocketErrorDomain
	                           code:LYTGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"LYTGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"LYTGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:LYTGCDAsyncUdpSocketErrorDomain
	                           code:LYTGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"LYTGCDAsyncUdpSocketClosedError",
	                                                     @"LYTGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:LYTGCDAsyncUdpSocketErrorDomain code:LYTGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:LYTGCDAsyncUdpSocketErrorDomain
	                           code:LYTGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError **)errPtr
{
	...
	int(^createSocket)(int) = ^int (int domain) {
         ...
         *
         * This is the reason of #222(LYTGCD does not necessarily return the size of an entire UDP packet) and
         *  #535(LYTGCDAsyncUDPSocket can not send data when data is greater than 9K)
         *
         *
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		LYTGCDAsyncUdpSpecialPacket *packet = [[LYTGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[LYTGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		LYTGCDAsyncUdpSpecialPacket *connectPacket = (LYTGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	LYTGCDAsyncUdpSendPacket *packet = [[LYTGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	LYTGCDAsyncUdpSendPacket *packet = [[LYTGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [LYTGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(LYTGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(LYTGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	LYTGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[LYTGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			LYTGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(LYTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(LYTGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	LYTGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
- (void)doReceive
{
	...
	if (doReceive4)
	{
		...
		// #222: LYTGCD does not necessarily return the size of an entire UDP packet 
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:LYTGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(LYTGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(LYTGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		LYTGCDAsyncUdpSocket *asyncUdpSocket = (__bridge LYTGCDAsyncUdpSocket *)pInfo;
